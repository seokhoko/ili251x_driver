...
/*
static void ili251x_reset()
{
	nxp_soc_gpio_set_io_func(PAD_GPIO_E + 21, 1);
	usleep_range(50, 100);
	nxp_soc_gpio_set_io_func(PAD_GPIO_E + 21, 0);
	msleep(100);
}
*/
				       ...
				       const struct i2c_device_id *id)
{
	...
	dev_err(dev, "Probing for ili251x I2C Touschreen driver");
...
static int __devexit ili251x_remove(struct i2c_client *client)
{
	struct ili251x_data *data = i2c_get_clientdata(client);
